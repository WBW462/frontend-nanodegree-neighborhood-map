...
var markers = [], nbrMarkers, map, Loc = function(a) {
    ...
    venues.forEach(function(b) {
        ...
        for (c.matches || drawer.classList.remove("open"), a.chosenMarker(b.location), i = 0; i < nbrMarkers; i++) b.location == markers[i].markerItem.title && google.maps.event.trigger(markers[i].markerItem, "click");
